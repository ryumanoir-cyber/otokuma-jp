...
(function () {
  ...
  function makePrompt() {
    ...
    if (tarot) {
      ...
      line();
      line("　対応表は、鑑定書の冒頭（結論の直後）に、必ず次の形式で書き出してください。省略禁止です。");
      line();
      line("　　【今回の札】");
      line("　　　1枚目　◯◯（正/逆）─ （1つ目の悩み）");
      line("　　　2枚目　◯◯（正/逆）─ （2つ目の悩み）");
      line("　　　…");
      line("　　　7枚目　◯◯（正/逆）─ 本人が気づいていないこと");
      line("　　　8枚目　◯◯（正/逆）─ 今、助けになるもの");
      line("　　　9枚目　◯◯（正/逆）─ 今、妨げになるもの");
      line("　　　10枚目　◯◯（正/逆）─ この相談への結論");
      line("　　　（札が回らなかった悩みがあれば：◯◯ ─ 他の占術で読む）");
      line();
      line("　10枚すべてを表に載せます。使わなかった札を作ってはいけません。");
      line("　どのカードがどの悩みに当たったか、どの悩みに札が無かったかを、");
      line("　読者に見える形にします。伏せると、後から都合よく選んだのと区別がつきません。");
      line();
      line("【読み方】");
