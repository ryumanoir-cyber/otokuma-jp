...
(function () {
  ...
  function makePrompt() {
    ...
    line();
    line("━━━━━━━━━━━━━━━━━━━━");
    line("【この人の基礎的な性質 ─ 長々と説明し直さないこと】");
    line("━━━━━━━━━━━━━━━━━━━━");
    line("以下は命式から読める基礎的な性質です。本鑑定では、これらを一から長く解説し直さないでください。");
    line("ただし、購入者の中には無料鑑定を経ずに直接購入した人もいます。");
    line("そのため、鑑定文の中で「無料鑑定」に言及したり、「無料鑑定で触れた」「先にお伝えした通り」のように");
    line("既に伝えた前提で参照してはいけません。これらの性質に触れる必要があるときは、初めて伝えるつもりで、");
    line("相談への回答に必要な範囲だけ簡潔に書いてください。");
    line();
    [["宿命・本質", R.destiny[k]], ["性格", R.character[k]],
     ["社会での出方", R.tsuhen[ms.tsuhen]], ["恋愛・結婚", R.love[k]],
     ["仕事・お金", R.work[k]], ["今の段階", R.junisei[ms.junisei]],
    ...
    line("　 見出しは「一番鑑定してほしいこと」「悩み」「その他」です。");
